                ...
                <Box p="8">
                    <Flex direction={{ base: "column", lg: "row" }} gap="8">
                        <Flex direction="column" gap="6" flex="1">
                            <Box>
                                <Text fontSize="sm" fontWeight="medium" color="fg.muted" mb="2">Name</Text>
                            ...
                            <Box>
                                <Text fontSize="sm" fontWeight="medium" color="fg.muted" mb="2">Code</Text>
                        ...
                        <Flex direction="column" gap="6" flex="1">
                            <Box>
                                <Text fontSize="sm" fontWeight="medium" color="fg.muted" mb="2">Type</Text>
                    ...
                    <Flex wrap="wrap" justifyContent="flex-end" gap="3" mt="8">
                        <Box as="button" onClick={handleCancel} px="8" py="2.5" borderRadius="lg" fontSize="sm" fontWeight="medium" border="xs" borderColor="border.muted" color="fg.muted" cursor="pointer" _hover={{ bg: "slate.50" }}>Clear</Box>
