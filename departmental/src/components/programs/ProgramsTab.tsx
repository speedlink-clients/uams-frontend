        ...
        return (
            <Flex alignItems="center" justifyContent="center" minH="400px">
                <Flex direction="column" alignItems="center" gap="4">
                    ...
                    <Text color="slate.500">Loading programs...</Text>
                </Flex>
            </Flex>
        );
    }
        ...
        return (
            <Box bg="white" borderRadius="2xl" p="8" border="1px solid" borderColor="gray.100" boxShadow="sm">
                ...
                <Flex direction={{ base: "column", lg: "row" }} gap="8">
                    ...
                    <Flex direction="column" gap="6" flex="1">
                        <Box>
                            <Text fontSize="sm" fontWeight="medium" color="slate.700" mb="2">Program Type</Text>
                    ...
                    <Box as="table" w="full" textAlign="left">
                        <Box as="thead">
                            <Box as="tr" bg="slate.50" borderY="1px solid" borderColor="gray.100">
                                ...
                                <Box as="th" px="6" py="4" fontSize="11px" fontWeight="bold" color="slate.500" textTransform="uppercase">Program Name</Box>
                                <Box as="th" px="6" py="4" fontSize="11px" fontWeight="bold" color="slate.500" textTransform="uppercase">Type</Box>
                                <Box as="th" px="6" py="4" fontSize="11px" fontWeight="bold" color="slate.500" textTransform="uppercase">Duration</Box>
                        ...
                        <Box as="tbody">
                            {filtered.length === 0 ? (
                                ...
                                <Box as="tr" key={prog.id} _hover={{ bg: "slate.50" }} borderBottom="1px solid" borderColor="gray.50" fontSize="sm" color="slate.600" bg={selectedIds.includes(prog.id) ? "blue.50" : undefined}>
                                    ...
                                    <Box as="td" px="6" py="4" fontWeight="semibold" color="slate.700">{prog.name}</Box>
                                    ...
                                    <Box as="td" px="6" py="4" textAlign="center">
                                        <Flex justifyContent="center" gap="2">
                                            <Box as="button" onClick={() => navigate(`/program-courses/programs/edit/${prog.id}`)} p="1" _hover={{ bg: "slate.100" }} borderRadius="full" color="slate.400" cursor="pointer" border="none" bg="transparent"><Edit size={16} /></Box>
